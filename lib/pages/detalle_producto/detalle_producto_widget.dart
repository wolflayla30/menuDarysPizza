...
class DetalleProductoWidget extends StatefulWidget {
  const DetalleProductoWidget({
    Key? key,
    required this.pizzass,
  }) : super(key: key);

  final TipospizzasRecord? pizzass;
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          valueOrDefault<String>(
                            widget.pizzass?.precioporcion?.toString(),
                            '0',
                          ),
                          style: FlutterFlowTheme.of(context).bodyMedium,
                        ),
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          valueOrDefault<String>(
                            widget.pizzass?.preciobandeja4?.toString(),
                            '0',
                          ),
                          style: FlutterFlowTheme.of(context).bodyMedium,
                        ),
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          valueOrDefault<String>(
                            widget.pizzass?.preciobandeja8?.toString(),
                            '0',
                          ),
                          style: FlutterFlowTheme.of(context).bodyMedium,
                        ),
