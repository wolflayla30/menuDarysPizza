            ...
            children: [
              Container(
                ...
                child: Padding(
                  ...
                  child: StreamBuilder<List<TipospizzasRecord>>(
                    stream: queryTipospizzasRecord(),
                    builder: (context, snapshot) {
                      ...
                      List<TipospizzasRecord> listViewTipospizzasRecordList =
                          snapshot.data!;
                      return ListView.builder(
                        padding: EdgeInsets.zero,
                        shrinkWrap: true,
                        scrollDirection: Axis.vertical,
                        itemCount: listViewTipospizzasRecordList.length,
                        itemBuilder: (context, listViewIndex) {
                          final listViewTipospizzasRecord =
                              listViewTipospizzasRecordList[listViewIndex];
                          return InkWell(
                            ...
                            onTap: () async {
                              context.pushNamed(
                                'detalleProducto',
                                queryParameters: {
                                  'pizzass': serializeParam(
                                    listViewTipospizzasRecord,
                                    ParamType.Document,
                                  ),
                                }.withoutNulls,
                                extra: <String, dynamic>{
                                  'pizzass': listViewTipospizzasRecord,
                                },
                              );
                            },
                            child: Container(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network(
                                        listViewTipospizzasRecord.imagen,
                                        width: 80.0,
                                        height: 80.0,
                                        fit: BoxFit.cover,
                                      ),
                                  ...
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            listViewTipospizzasRecord.nombre,
